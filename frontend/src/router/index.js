  ...
  },
  {
    ...
    children: [
      // ── 工作台 ──
      {
        ...
        meta: { title: '控制中心 Dashboard', permission: [1, 2, 4, 5] }
      },
      {
        path: 'workbench',
        name: 'Workbench',
        component: () => import('@/views/workbench/index.vue'),
        meta: { title: '订单工作台 (进度追踪)', permission: [1, 2, 3, 5] }
      },
      // ── 商机管理 ──
      {
        path: 'rfq',
        ...
        meta: { title: '商机管理 (RFQs)', permission: [1, 2, 3] }
      },
      {
        path: 'quotations',
        name: 'Quotations',
        component: () => import('@/views/quotations/index.vue'),
        meta: { title: '商务报价单 (Quotations)', permission: [1, 2, 3] }
      },
      {
        path: 'samples',
        name: 'Samples',
        component: () => import('@/views/samples/index.vue'),
        meta: { title: '样品管理 (Samples)', permission: [1, 2, 3, 5] }
      },
      // ── 订单 ──
      {
        path: 'orders',
        ...
        meta: { title: '外销订单 (Proforma Invoice)', permission: [1, 2, 3, 5] }
      },
      // ── 供应链采购 ──
      {
        ...
        meta: { title: '购销合同', permission: [1, 2, 4, 5] }
      },
      {
      ...
      // ── 物流与品控 ──
      {
        ...
        meta: { title: '订舱委托书 (Shipping Order)', permission: [1, 2, 5] }
      },
      {
        path: 'qc',
        name: 'Qc',
        component: () => import('@/views/qc/index.vue'),
        meta: { title: '质量检验 (QC质检)', permission: [1, 2] }
      },
      {
        path: 'loadmaster',
        name: 'Loadmaster',
        component: () => import('@/views/loadmaster/index.vue'),
        meta: { title: 'LoadMaster (装柜测算)', permission: [1, 2] }
      },
      // ── 关务单证 ──
      {
